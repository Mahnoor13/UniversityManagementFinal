...
class StudentsResourceIT {
    ...
    public static Students createEntity(EntityManager em) {
        Students students = new Students().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).phone(DEFAULT_PHONE);
        return students;
    }
    ...
    public static Students createUpdatedEntity(EntityManager em) {
        Students students = new Students().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE);
        return students;
    }
    ...
    void createStudents() throws Exception {
        ...
        assertThat(testStudents.getPhone()).isEqualTo(DEFAULT_PHONE);
    }
    ...
    void getAllStudentsWithEagerRelationshipsIsEnabled() throws Exception {
        ...
        restStudentsMockMvc.perform(get(ENTITY_API_URL + "?eagerload=true")).andExpect(status().isOk());
    ...
    void putNewStudents() throws Exception {
        ...
        updatedStudents.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE);
        ...
        assertThat(testStudents.getPhone()).isEqualTo(UPDATED_PHONE);
    }
    ...
    void fullUpdateStudentsWithPatch() throws Exception {
        ...
        partialUpdatedStudents.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phone(UPDATED_PHONE);
